  ...
  <div>
    ...
    >
      <input
        ...
        v-bind:value="value"
        style="outline-color: #CEE6FF; outline-width: thick;"
      ...
      <div class="Password__icons">
        ...
        <div
          v-if="badge"
          v-bind:class="[strengthMeterFillClassWording]"
  ...
  export default {
    props: {
      ...
      */
      ...
      strengthMeterFillClassWording: {
        type: String,
        default: 'Password__strength-meter-wording--fill'
      },
      /**
    ...
    watch: {
      ...
      passwordStrength (score) {
        ...
        switch (score) {
          case 0:
            return this.wording = 'Sangat Lemah';
          case 1:
            return this.wording = 'Lemah';
          case 2:
            return this.wording = 'Sedang';
          case 3:
            return this.wording = 'Kuat';
          case 4:
            return this.wording = 'Sangat Kuat';
        }
        // if (score === 0) {
        //   console.log('nol')
        // } else if(score === 1) {
...
<style lang="scss">
  ...
  .Password__strength-meter-wording {
    background: transparent;
    height: inherit;
    position: absolute;
    width: 0;
  ...
  .Password__strength-meter-wording--fill[data-score='0'] {
    color: darkred;
    margin-right: 20%;
    width: 140px;
  }

  .Password__strength-meter-wording--fill[data-score='1'] {
    color: orangered;
    margin-right: 20%;
  }

  .Password__strength-meter-wording--fill[data-score='2'] {
    color: orange;
    margin-right: 20%;
  }

  .Password__strength-meter-wording--fill[data-score='3'] {
    color: yellowgreen;
    margin-right: 20%;
  }

  .Password__strength-meter-wording--fill[data-score='4'] {
    color: green;
    margin-right: 20%;
    width: 120px;
  }
